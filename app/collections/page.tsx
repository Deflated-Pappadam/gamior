...
const items = [
  ...
  { id: 9, name: "Coffee Table", image: "/item.jpg", category: "bathroom" },
  { id: 10, name: "Coffee Table", image: "/item.jpg", category: "bathroom" },
  { id: 11, name: "Coffee Table", image: "/item.jpg", category: "wardrobe" }
];

const categories = ["all", "bedroom", "wardrobe", "dining", "kitchen", "bathroom"];
